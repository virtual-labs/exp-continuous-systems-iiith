...
var canvas = document.getElementById("cfrustum");
var ctx = canvas.getContext("2d");
drawCFrustum(canvas, ctx, "#C0C0C0", "black", 2);

function drawCFrustum(canvas, ctx, fill, border, lineWidth)
{
	canvas.width = 450;
    canvas.height = 450;
    ctx.translate(25,0);
    ...
    ctx.bezierCurveTo(145, 115, 135, 200, 120, 200);
    ctx.bezierCurveTo(100, 260, 50, 300, 30, 370);
